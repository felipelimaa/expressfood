...
insert into produto (nome, descricao, preco, ativo, restaurante_id) values ('Carne Assada', null, 10.99, 1, 1);
insert into produto (nome, descricao, preco, ativo, restaurante_id) values ('Picanha', null, 69.99, 1, 1);
insert into produto (nome, descricao, preco, ativo, restaurante_id) values ('Feijão Verde', null, 6.99, 1, 2);
